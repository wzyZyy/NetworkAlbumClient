...
public class BottomTabBar extends LinearLayout {
    ...
    private void init(final List<Bar> bars) {
        ...
        for (int i = 0; i < bars.size(); i++) {
            ...
            LinearLayout.LayoutParams blp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, 1);
            bar.setGravity(Gravity.CENTER);
            bar.setPadding(10, 16, 10, 16);
            ImageView image = new ImageView(getContext());
            LinearLayout.LayoutParams ilp = new LinearLayout.LayoutParams((int) getResources().getDimension(R.dimen.image_height), (int) getResources().getDimension(R.dimen.image_height));
