...
public class ShareImageAdapter extends RecyclerView.Adapter<ShareImageAdapter.ViewHolder> {
    ...
    public ShareImageAdapter(List<Image> imageList, ShareImageActivity imageActivity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.share_image_item, parent, false);
